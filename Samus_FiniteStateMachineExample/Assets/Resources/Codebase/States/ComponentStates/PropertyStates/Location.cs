...
{
	/* State of an Object's position and direction.  Store both current and previous values. */
	public class Location : GameState
	{
		...
		/* Returns itself; a LocationState has no other states that it can lead to. */
